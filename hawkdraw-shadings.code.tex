...
% PDF treats shadings as patterns and hence as fill (or stroke). But we want to ensure that shadings are reusable
% for different sizes or rotations, thus we apply approach of PGF/TikZ here.
