...
\NewDocumentCommand{\arrowtip}{ m }{%
  \begin{hawkdraw}[baseline={0.5ex}]
    \stroke[arrow end={#1}, stroke color=red, fill color=cyan]
      (0cm,0cm) -- (1cm,0cm) ;
  \end{hawkdraw}%
}
...
\begin{longtable}{ @{} p{2.5cm} p{\dimexpr\textwidth-2\tabcolsep-2.5cm} @{} }
  ...
  \arrowtip{simple} & \macro{simple} \\
  \arrowtip{straight} & \macro{straight} \\
  \arrowtip{bar} & \macro{bar} \\
  \bottomrule
\end{longtable}
