...
\def\hawkdrawfileversion{0.3.0}
\def\hawkdrawfiledate{15 June 2026}
...
\changes{v0.3.0}{2026/06/12}{Adding option to offset paths; fixing bug with positioning of points on arcs.}
...
\begin{macrodef}
!path/!|offset|={<dimension>}
\end{macrodef}
The option \macro{offset} require as argument a dimension representing the length by which the current path should be offset. Arrow tips are positioned at the updated start or end point of the path.
