...
The package does not directly work with ConTeXt, but it is possible to run PDFLaTeX from within ConTeXt to create a stand-alone PDF file from the relevant drawing that can then be included into the ConTeXt document.
