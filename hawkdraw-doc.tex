...
\end{macrodef}
The position of the arrow head can be adjusted with the \macro{at part} option which accespts a floating-point number (see \hyperlink{key:atpathpart}{above}).
