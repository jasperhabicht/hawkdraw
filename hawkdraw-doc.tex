...
\def\hawkdrawfiledate{5 June 2026}
...
\changes{v0.1.1}{2026/06/05}{Fixing bug in arrow tip slopes; fixing bug in tagging support; improving option setting; adding option to set bounding box; adding ConTeXt module.}
...
To load the module in ConTeXt, call \macro{\usemodule[hawkdraw]}. The drawing code can the be used between the commands \macro{\starthawkdraw} and \macro{\stophawkdraw}.
