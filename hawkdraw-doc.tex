...
\def\hawkdrawfileversion{0.6.0}
\def\hawkdrawfiledate{27 July 2026}
...
\changes{v0.6.0}{2026/07/27}{Improving support for XeLaTeX.}
...
\warning The \macro{hawkdraw} package supports PDFLaTeX and LuaLaTeX in full. Most of the basic commands should work with other compilation engines as well. Some features such as shadings or complex opacity settings, however, might not be fully supported with LaTeX (via DVI) or XeLaTeX.
