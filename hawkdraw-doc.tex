...
\def\hawkdrawfileversion{0.7.0}
\def\hawkdrawfiledate{5 August 2026}
...
\changes{v0.7.0}{2026/08/05}{Adding pattern and shading support to nodes; adding option to apply patterns to strokes; adding soft mask support to ConTeXt module.}
