...
|\getlength|
\end{macrodef}
Inside a \macro{hawkdraw} environment, the command \macro{\getlength} retrieves the length of the current path (up to this point) and returns the length as dimension that can be used in subsequent calculations.
