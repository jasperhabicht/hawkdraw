...
\end{macrodef}
The options \macro{shorten start} and \macro{shorten end} each require as argument a dimension representing the length by which the current path should be shortenend at its start or end. Only the first or last segment of the path is affected by this manipulation.
