...
!path/!|offset|={<clist>}
\end{macrodef}
The option \macro{offset} requires as argument a comma-separated list of dimensions each representing the length by which the current path should be offset. Arrow tips are positioned at the updated start or end point of the path.
