...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_curve_cubic_set_points:nnnn #1#2#3#4 {
    \fp_set:Nn \l__hawkdraw_softpath_offset_curve_point_tmpa_fp {
        hawkdrawlerp ( ( #1 ) , ( #2 ) , 1/3 )
    }
    \fp_set:Nn \l__hawkdraw_softpath_offset_curve_point_tmpb_fp {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_curve_point_tmpm_fp {
        ( \l__hawkdraw_softpath_offset_curve_point_tmpd_fp ) + ( 
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_curve_point_tmpn_fp {
        ( \l__hawkdraw_softpath_offset_curve_point_tmpe_fp ) + ( 
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_curve_point_tmpp_fp {
        ( \l__hawkdraw_softpath_offset_curve_point_tmpg_fp ) + ( 
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_curve_point_tmpo_fp {
        (
...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_curve_cubic:nnnn #1#2#3#4 {
    \__hawkdraw_softpath_offset_curve_cubic_set_points:nnnn {#1} {#2} {#3} {#4}
...
\fp_const:Nn \c_hawkdraw_softpath_ellipse_factor_fp {
    4 / 3 * tan( pi / 8 )
}
...
\cs_new_protected:Npn \hawkdraw_softpath_offset_ellipse_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_ellipse_point_tmpb_fp {
        ( #1 , #2 ) + 
        ( #4 , #5 ) +
        \c_hawkdraw_softpath_ellipse_factor_fp * ( #7 , #8 )
    }
    \fp_set:Nn \l__hawkdraw_softpath_offset_ellipse_point_tmpc_fp {
        ( #1 , #2 ) +
        \c_hawkdraw_softpath_ellipse_factor_fp * ( #4 , #5 ) +
        ( #7 , #8 )
    }
    ...
    \__hawkdraw_softpath_offset_curve_cubic_set_points:nnnn {
    ...
    \__hawkdraw_softpath_offset_ellipse:
...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_ellipse: {
    \hawkdraw_softpath_update_curveto:nnn {
        \l__hawkdraw_softpath_offset_curve_point_tmpj_fp
    } {
        \l__hawkdraw_softpath_offset_curve_point_tmpk_fp
