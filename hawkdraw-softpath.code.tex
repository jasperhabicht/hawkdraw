...
\int_step_inline:nn { 10 } {
    \fp_new:c {
        l__hawkdraw_softpath_offset_construct_cubic_point_ \int_to_alph:n {#1 } _fp
    }
}
...
% we use the mechanism for cubic Béziers also for quadratic Béziers, arcs and allipses
% splits the relevant cubic Bézer into three segments, also cubic Bézer each
\cs_new_protected:Npn \__hawkdraw_softpath_offset_construct_cubic_set_points:nnnn #1#2#3#4 {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_tmph_fp {
        hawkdrawlerp ( ( #3 ) , ( #4 ) , 2/3 )
    }

    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_a_fp {
        ( #1 ) + (
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_b_fp {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_c_fp {
        ( \l__hawkdraw_softpath_offset_construct_cubic_point_tmpb_fp ) + (
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_e_fp {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_f_fp {
        ( \l__hawkdraw_softpath_offset_construct_cubic_point_tmpe_fp ) + (
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_h_fp {
        ( \l__hawkdraw_softpath_offset_construct_cubic_point_tmpg_fp ) + (
            \draw_point_polar:nn {
                ...
                \hawkdraw_calculate_slope:nn {
                    ...
                    \l__hawkdraw_softpath_offset_construct_cubic_point_tmph_fp
                } + 90
            }
        )
    }
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_i_fp {
        ( \l__hawkdraw_softpath_offset_construct_cubic_point_tmph_fp ) + (
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_j_fp {
        ( #4 ) + (
            \draw_point_polar:nn {
                \l_hawkdraw_softpath_offset_dim
            } {
    ...
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_d_fp {
        (
            ( \l__hawkdraw_softpath_offset_construct_cubic_point_c_fp ) +
            ( \l__hawkdraw_softpath_offset_construct_cubic_point_e_fp )
        ) / 2
    }
    \fp_set:Nn \l__hawkdraw_softpath_offset_construct_cubic_point_g_fp {
        (
            ( \l__hawkdraw_softpath_offset_construct_cubic_point_f_fp ) +
            ( \l__hawkdraw_softpath_offset_construct_cubic_point_h_fp )
        ) / 2
    }
}

\cs_new_protected:Npn \__hawkdraw_softpath_offset_curve_quadratic:nnn #1#2#3 {
    \__hawkdraw_softpath_offset_construct_cubic_set_points:nnnn {#1} {
        ( #1 ) + 2/3 * ( ( #2 ) - ( #1 ) )
    } {
        ( #3 ) + 2/3 * ( ( #2 ) - ( #3 ) )
    } {#3}
    ...
    \bool_if:NT \l__hawkdraw_softpath_offset_moveto_bool {
        \bool_set_false:N \l__hawkdraw_softpath_offset_moveto_bool
        \fp_gset_eq:NN \g_hawkdraw_path_point_first_fp
            \l__hawkdraw_softpath_offset_construct_cubic_point_a_fp
        \hawkdraw_softpath_update_moveto:n {
            \g_hawkdraw_path_point_first_fp
        }
    }
    ...
    \hawkdraw_softpath_update_curveto:nnn {
        \l__hawkdraw_softpath_offset_construct_cubic_point_b_fp
    } {
        \l__hawkdraw_softpath_offset_construct_cubic_point_c_fp
    } {
        \l__hawkdraw_softpath_offset_construct_cubic_point_d_fp % <
    }
    \hawkdraw_softpath_update_curveto:nnn {
        \l__hawkdraw_softpath_offset_construct_cubic_point_e_fp
    } {
        ...
        \l__hawkdraw_softpath_offset_construct_cubic_point_g_fp % <
    }
    \hawkdraw_softpath_update_curveto:nnn {
        \l__hawkdraw_softpath_offset_construct_cubic_point_h_fp
    } {
        \l__hawkdraw_softpath_offset_construct_cubic_point_i_fp
    } {
        \l_hawkdraw_softpath_offset_point_last_fp
    }
...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_curve_cubic:nnnn #1#2#3#4 {
    \__hawkdraw_softpath_offset_construct_cubic_set_points:nnnn {#1} {#2} {#3} {#4}
...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_construct_cubic: {
    \hawkdraw_softpath_update_curveto:nnn {
        \l__hawkdraw_softpath_offset_construct_cubic_point_b_fp
    } {
        \l__hawkdraw_softpath_offset_construct_cubic_point_c_fp
    ...
    \hawkdraw_softpath_update_curveto:nnn {
        ...
        \l__hawkdraw_softpath_offset_construct_cubic_point_j_fp
    }
}
...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_arc_axes:nnnn #1#2#3#4 {
    ...
    \bool_if:NTF \l__hawkdraw_softpath_offset_moveto_bool {
        ...
        \fp_set_eq:NN \l__hawkdraw_softpath_offset_construct_cubic_point_a_fp
            \g_hawkdraw_path_point_last_fp
        \hawkdraw_softpath_update_lineto:n {
            \l__hawkdraw_softpath_offset_construct_cubic_point_a_fp
        }
    }
    \__hawkdraw_softpath_offset_construct_cubic:
...
\cs_new_protected:Npn \__hawkdraw_softpath_offset_arc_axes_construct_quarter:nnnnn #1#2#3#4#5 {
    ...
    \__hawkdraw_softpath_offset_construct_cubic_set_points:nnnn {
        \l__hawkdraw_softpath_offset_arc_point_tmpa_fp
    } {
