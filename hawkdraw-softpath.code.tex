...
\fp_new:N \l_hawkdraw_softpath_path_length_fp

\cs_new_protected:Npn \hawkdraw_softpath_get_path_length: {
    \group_begin:
        \fp_zero:N \l_hawkdraw_softpath_path_length_fp
        ...
        \clist_map_inline:nn {
            ...
            \cs_set_eq:cc {
                ...
                __hawkdraw_softpath_path_length_ ##1
            }
        }
        \tl_use:N \l_hawkdraw_softpath_intermediate_tl
        \fp_gset_eq:NN \g_hawkdraw_path_length_fp \l_hawkdraw_softpath_path_length_fp
    \group_end:
}

\cs_new_protected:Npn \__hawkdraw_softpath_path_length_close_op:nn #1#2 {
    \draw_path_moveto:n { #1 , #2 }
}

\cs_new_protected:Npn \__hawkdraw_softpath_path_length_moveto_op:nn #1#2 {
    \fp_set:Nn \l_hawkdraw_softpath_point_last_fp { #1 , #2 }
}

\cs_new_protected:Npn \__hawkdraw_softpath_path_length_lineto_op:nn #1#2 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
...
\cs_new_protected:Npn \__hawkdraw_softpath_path_length_curveto_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    \tl_if_empty:nTF {#7} {
        \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
...
\cs_new_protected:Npn \hawkdraw_softpath_path_length_arc_op:nnNnn #1#2#3#4#5 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
...
\cs_new_protected:Npn \hawkdraw_softpath_path_length_arc_axes_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
...
\cs_new_protected:Npn \hawkdraw_softpath_path_length_circle_op:nnNnn #1#2#3#4#5 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
        \__hawkdraw_path_length_circle:n {#4}
    }
}

\cs_new_protected:Npn \hawkdraw_softpath_path_length_ellipse_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
        \__hawkdraw_path_length_ellipse:nnn { #1 , #2 } { #4 , #5 } { #7 , #8 }
    }
}

\cs_new_protected:Npn \hawkdraw_softpath_path_length_rectangle_op:nnNnn #1#2#3#4#5 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
...
\cs_new_protected:Npn \hawkdraw_softpath_path_length_grid_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    \fp_add:Nn \l_hawkdraw_softpath_path_length_fp {
