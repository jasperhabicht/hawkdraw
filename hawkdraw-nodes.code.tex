    ...
    \hcoffin_set:Nn \l_hawkdraw_node_frame_coffin {
        \draw_suspend_begin:
            ...
            \draw_begin:
                ...
                \cs_if_exist_use:cTF { hawkdraw_node_frame_set_ \l_hawkdraw_node_frame_tl :NNVVVV } {
...
\cs_new_protected:Npn \hawkdraw_node_create_frame:nnn #1#2#3 {
    \cs_new_protected:cpn { hawkdraw_node_frame_set_ #1 :NNnnnn } ##1##2##3##4##5##6 {
        \dim_set:Nn \l_hawkdraw_node_natural_width_dim {
            \coffin_wd:N ##2 + ##3 + ##4
        }
        \dim_set:Nn \l_hawkdraw_node_natural_height_dim {
            \coffin_ht_plus_dp:N ##2 + ##5 + ##6
        }
        \tl_set:Nn ##1 {#2}
    }
    \cs_generate_variant:cn { hawkdraw_node_frame_set_ #1 :NNnnnn } { NNVVVV }
