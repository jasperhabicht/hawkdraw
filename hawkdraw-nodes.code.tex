...
\tl_new:N \l_hawkdraw_tag_node_tl

\NewTaggingSocket { hawkdraw / node / before } { 1 }
\NewTaggingSocket { hawkdraw / node / after } { 0 }
...
\cs_new_protected:Npn \hawkdraw_node_put:nn #1#2 {
    \draw_scope_begin:
        ...
        \tag_socket_use:nV { hawkdraw / node / before } \l_hawkdraw_tag_node_tl
        \tag_suspend:n { hawkdraw / node }
        ...
        \tag_socket_use:n { hawkdraw / node / after }
    \draw_scope_end:
}
