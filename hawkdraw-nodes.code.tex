...
\cs_new_protected:Npn \hawkdraw_put_node:nn #1#2 {
    \draw_scope_begin:
        ...
        \fp_set:Nn \l_hawkdraw_point_at_path_part_fp { nan }
        \keys_set_known:nnN { hawkdraw / path / point } {#1}
            \l__hawkdraw_keys_unprocessed_clist
        \fp_if_nan:nF { \l_hawkdraw_point_at_path_part_fp } {
            \fp_set:Nn \l_hawkdraw_point_at_fp {
                \cs_if_exist_use:cT {
                    __hawkdraw_point_part_ \l__hawkdraw_path_type_str :V
                } {
                    \l_hawkdraw_point_at_path_part_fp
                }
            }
            \fp_set:Nn \l_hawkdraw_point_slope_fp {
                \cs_if_exist_use:cTF {
                    __hawkdraw_point_part_slope_ \l__hawkdraw_path_type_str :V
                } {
                    \l_hawkdraw_point_at_path_part_fp
                } {
                    0
        ...
        \tl_if_blank:nF \l_hawkdraw_point_name_tl {
            \prop_if_exist:cF {
        ...
        \bool_if:NT \l_hawkdraw_node_sloped_bool {
            \coffin_rotate:Nn \l_hawkdraw_node_frame_coffin { \l_hawkdraw_point_slope_fp }
        }
        \exp_args:Ne
