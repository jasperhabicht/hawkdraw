...
\tl_new:N \l_hawkdraw_node_text_render_mode_tl
\tl_new:N \l_hawkdraw_node_text_render_mode_scope_tl
...
\keys_define:nn { hawkdraw / path / node } {
    ...
    text ~ render ~ mode    .tl_set:N       = \l_hawkdraw_node_text_render_mode_tl ,
    text ~ render ~ mode ~ scope
                            .choice: ,
    text ~ render ~ mode ~ scope / node
                            .code:n         = {
        \tl_set:Nn \l_hawkdraw_node_text_render_mode_scope_tl { node }
    } ,
    text ~ render ~ mode ~ scope / path
                            .code:n         = {
        \tl_set:Nn \l_hawkdraw_node_text_render_mode_scope_tl { path }
    } ,
    text ~ render ~ mode ~ scope / scope
                            .code:n         = {
        \tl_set:Nn \l_hawkdraw_node_text_render_mode_scope_tl { scope }
    } ,
    text ~ render ~ mode ~ scope / picture
                            .code:n         = {
        \tl_set:Nn \l_hawkdraw_node_text_render_mode_scope_tl { picture }
    } ,
    text ~ render ~ mode ~ scope
                            .initial:n      = { node } ,
    text ~ style ~ set      .clist_set:N    = \l_hawkdraw_node_text_keys_clist ,
    text ~ style ~ add      .code:n         = {
        \clist_put_right:Nn \l_hawkdraw_node_text_keys_clist {#1}
    } ,
...
\prop_const_from_keyval:Nn \c__hawkdraw_node_text_render_mode_prop {
    fill                 = 0 ,
    stroke               = 1 ,
    fill ~ stroke        = 2 ,
    none                 = 3 ,
...
\cs_new_protected:Npn \hawkdraw_node_text_render_mode_stack_init: {
    \str_if_eq:VnF \l_hawkdraw_node_text_render_mode_tl { fill } {
        \int_const:Nn \c__hawkdraw_node_text_render_mode_stack_int {
...
\cs_new_protected:Npn \hawkdraw_node_text_render_mode_stack_push:n #1 {
    \int_if_exist:NF \c__hawkdraw_node_text_render_mode_stack_int {
        \hawkdraw_node_text_render_mode_stack_init:
    }
    \int_if_exist:NT \c__hawkdraw_node_text_render_mode_stack_int {
        \hawkdraw_support_pdfcolorstack:e {
            \int_use:N \c__hawkdraw_node_text_render_mode_stack_int ~ push ~ {
                \prop_item:Nn \c__hawkdraw_node_text_render_mode_prop {#1} ~ Tr ~
            }
        }
    }
}
\cs_generate_variant:Nn \hawkdraw_node_text_render_mode_stack_push:n { V }

\cs_new_protected:Npn \hawkdraw_node_text_render_mode_stack_pop: {
    \int_if_exist:NT \c__hawkdraw_node_text_render_mode_stack_int {
        \hawkdraw_support_pdfcolorstack:e {
            \int_use:N \c__hawkdraw_node_text_render_mode_stack_int ~ pop \scan_stop:
        }
    }
}

\cs_new_protected:Npn \hawkdraw_node_text_render_apply: {
    \prop_if_in:NVT \c__hawkdraw_node_text_render_mode_prop
        \l_hawkdraw_node_text_render_mode_tl {
        \hawkdraw_node_text_render_mode_stack_push:V
            \l_hawkdraw_node_text_render_mode_tl

        \hook_gput_next_code:nn {
            hawkdraw / \l_hawkdraw_node_text_render_mode_scope_tl / end
        } {
            \hawkdraw_node_text_render_mode_stack_pop:
        }
    }
...
\cs_new_protected:Npn \hawkdraw_node_contents:n #1 {
    ...
    \normalfont
    \keys_set:nV { hawkdraw / path } \l_hawkdraw_node_text_keys_clist
    \hawkdraw_path_set_options:
    \hawkdraw_node_text_render_apply:
