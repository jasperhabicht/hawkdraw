...
\tl_new:N \l_hawkdraw_node_preactions_tl
...
\cs_new_protected:Npn \hawkdraw_node:nn #1#2 {
    \draw_scope_begin:
        % if text clip
        \pdfliteral { 7 ~ Tr ~ } % too late already
        % if
        ...
        % if text clip
        \tl_put_right:Nn \l_hawkdraw_node_preactions_tl {
            \draw_coffin_use:Nnn \l_hawkdraw_node_coffin { hc } { vc }
        }
...
\cs_new_protected:Npn \__hawkdraw_node_set_frame:n #1 {
    \hcoffin_set:Nn \l_hawkdraw_node_frame_coffin {
        \draw_suspend_begin:
            ...
            \draw_begin:
                \tl_use:N \l_hawkdraw_node_preactions_tl
