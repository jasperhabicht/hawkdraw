...
\dim_new:N \g_hawkdraw_softmask_bbox_xmin_dim
\dim_new:N \g_hawkdraw_softmask_bbox_ymin_dim

\box_new:N \l__hawkdraw_softmask_box
...
\cs_new_protected:Npn \hawkdraw_softmask_set:nn #1#2 {
    \int_if_exist:cTF {
        ...
        \hbox_set:Nn \l__hawkdraw_softmask_box {
            \draw_suspend_begin:
                \draw_begin:
                    #2
                \draw_end:
                \dim_gset_eq:NN
                    \g_hawkdraw_softmask_bbox_xmin_dim
                    \g_draw_bb_xmin_dim
                \dim_gset_eq:NN
                    \g_hawkdraw_softmask_bbox_ymin_dim
                    \g_draw_bb_ymin_dim
            \draw_suspend_end:
        }
        \pdfxform_new:nnn { hawkdraw_softmask_ #1 } { } {
            \draw_box_use:Nn \l__hawkdraw_softmask_box {
                \g_hawkdraw_softmask_bbox_xmin_dim
            ,
                \g_hawkdraw_softmask_bbox_ymin_dim
            }
