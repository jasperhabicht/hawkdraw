...
\tl_new:N \l_hawkdraw_softpath_updated_tl

\dim_new:N \l_hawkdraw_path_shorten_start_dim
\dim_new:N \l_hawkdraw_path_shorten_end_dim
\bool_new:N \l__hawkdraw_path_shorten_start_bool
\tl_new:N \l_hawkdraw_path_shorten_point_last_fp

\cs_new_protected:Npn \hawkdraw_path_shorten: {
    \group_begin:
        ...
        \clist_map_inline:nn {
            ...
            \cs_set_eq:cc {
                ...
                __hawkdraw_path_shorten_ ##1
            }
        }
        \tl_use:N \g_hawkdraw_softpath_original_tl

        % eventually, we need to update \g_hawkdraw_softpath_original_tl

    \group_end:
}

\cs_new_protected:Npn \__hawkdraaw_path_shorten_lookahead:nN #1#2 {
...
\cs_new_protected:Npn \__hawkdraw_path_shorten_moveto_op:nn #1#2 {
...
\cs_new_protected:Npn \__hawkdraw_path_shorten_lineto_op:nn #1#2 {
    \fp_set_eq:NN \l_hawkdraw_path_shorten_point_last_fp \l_hawkdraw_softpath_point_last_fp
    \__hawkdraaw_path_shorten_lookahead:nN {
        \__hawkdraw_path_shorten_line:nn {
            \l_hawkdraw_path_shorten_point_last_fp
        } { #1 , #2 }
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_line:nn #1#2 {
    ...
    \bool_lazy_and:nnTF {
        ...
        \draw_path_lineto:n {#2}
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_curveto_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    \fp_set_eq:NN \l_hawkdraw_path_shorten_point_last_fp \l_hawkdraw_softpath_point_last_fp
    \__hawkdraaw_path_shorten_lookahead:nN {
        \tl_if_empty:nTF {#7} {
            \__hawkdraw_path_shorten_curve_quadratic:nnn {
                \l_hawkdraw_path_shorten_point_last_fp
             }{ #1 , #2 } { #4 , #5 }
        } {
            \__hawkdraw_path_shorten_curve_cubic:nnnn {
                \l_hawkdraw_path_shorten_point_last_fp
            } { #1 , #2 } { #4 , #5 } { #7 , #8 }
        }
    }
...
\cs_new_protected:Npn \__hawkdraw_path_shorten_curve_quadratic:nnn #1#2#3 {
    ...
    \bool_lazy_and:nnTF {
        ...
        \bool_lazy_and:nnTF {
            ...
            \draw_path_curveto:nn {#2} {#3}
        }
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_curve_cubic:nnnn #1#2#3#4 {
    ...
    \bool_lazy_and:nnTF {
        ...
        \bool_lazy_and:nnTF {
            ...
            \draw_path_curveto:nnn {#2} {#3} {#4}
        }
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_arc_op:nnNnn #1#2#3#4#5 {
    \fp_set_eq:NN \l_hawkdraw_path_shorten_point_last_fp \l_hawkdraw_softpath_point_last_fp
    \__hawkdraaw_path_shorten_lookahead:nN {
        \__hawkdraw_path_shorten_arc:nnnn
            {#1} {#2} {#4} {#5}
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_arc:nnnn #1#2#3#4 {
    \fp_set:Nn \l_hawkdraw_softpath_point_last_fp {
        \l_hawkdraw_path_shorten_point_last_fp + (
            \__hawkdraw_point_part_arc:nnnnn
                { 1 } {#1} {#2} {#3} {#4}
    ...
    \bool_lazy_and:nnTF {
        ...
        \bool_lazy_and:nnTF {
            ...
            \draw_path_arc:nnnn {#1} {#2} {#3} {#4}
        }
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_arc_axes_op:nnNnnNnn #1#2#3#4#5#6#7#8 {
    \fp_set_eq:NN \l_hawkdraw_path_shorten_point_last_fp \l_hawkdraw_softpath_point_last_fp
    \__hawkdraaw_path_shorten_lookahead:nN {
        \__hawkdraw_path_shorten_arc_axes:nnnn
            { #1 , #2 } { #4 , #5 } {#7} {#8}
    }
}

\cs_new_protected:Npn \__hawkdraw_path_shorten_arc_axes:nnnn #1#2#3#4 {
    \fp_set:Nn \l_hawkdraw_softpath_point_last_fp {
        \l_hawkdraw_path_shorten_point_last_fp + (
            \__hawkdraw_point_part_arc_axes:nnnnn
                { 1 } {#1} {#2} {#3} {#4}
    ...
    \bool_lazy_and:nnTF {
        ...
        \bool_lazy_and:nnTF {
            ...
            \draw_path_moveto:n {
                \__hawkdraw_point_part_arc_axes:nnnnn {
                    \l__hawkdraw_path_shorten_start_arc_axes_part_fp
                } {#1} {#2} {#3} {#4}
            }
            \draw_path_arc_axes:nnnn {#1} {#2} {
                #3 + \l__hawkdraw_path_shorten_start_arc_axes_part_fp * ( #4 - #3 )
            } {
                #4 + \l__hawkdraw_path_shorten_end_arc_axes_part_fp * ( #4 - #3 )
            }
        } {
            % arc: shorten end
            \draw_path_arc_axes:nnnn {#1} {#2} {#3} {
                #4 + \l__hawkdraw_path_shorten_end_arc_axes_part_fp * ( #4 - #3 )
            }
        }
    } {
        \bool_lazy_and:nnTF {
            ...
            \draw_path_arc_axes:nnnn {#1} {#2} {#3} {#4}
        }
    }
}
