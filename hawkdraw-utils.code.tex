...
\box_new:N \g__hawkdraw_support_pdfxform_tmp_box
\cs_new_protected:Npn \hawkdraw_support_pdfxform:nnN #1#2#3 {
    ...
    \sys_if_engine_xetex:T {
        \box_gset_eq:NN \g__hawkdraw_support_pdfxform_tmp_box #3
        \dim_const:cn {
            c__hawkdraw_support_pdfxform_
            \int_use:N \g__hawkdraw_support_pdfxform_int 
            _wd_dim
        } {
            \box_wd:N \g__hawkdraw_support_pdfxform_tmp_box
        }
        \dim_const:cn {
            c__hawkdraw_support_pdfxform_
            \int_use:N \g__hawkdraw_support_pdfxform_int 
            ...
            \box_ht:N \g__hawkdraw_support_pdfxform_tmp_box
        }
        \dim_const:cn {
            c__hawkdraw_support_pdfxform_
            \int_use:N \g__hawkdraw_support_pdfxform_int 
            ...
            \box_dp:N \g__hawkdraw_support_pdfxform_tmp_box
        }
        \box_gset_wd:Nn \g__hawkdraw_support_pdfxform_tmp_box { \c_zero_dim }
        \box_gset_ht:Nn \g__hawkdraw_support_pdfxform_tmp_box { \c_zero_dim }
        \box_gset_dp:Nn \g__hawkdraw_support_pdfxform_tmp_box { \c_zero_dim }
        \hook_gput_next_code:nn { shipout / background } {
            \mode_leave_vertical:
            \tex_special:D {
                pdf: ~ bxobj ~
                    @hawkdraw.xobj \int_use:N \g__hawkdraw_support_pdfxform_int \c_space_tl
                width  ~
                    \dim_use:c { c__hawkdraw_support_pdfxform_
                        \int_use:N \g__hawkdraw_support_pdfxform_int 
                        _wd_dim
                    } \c_space_tl
                height ~
            ...
            \box_use_drop:N \g__hawkdraw_support_pdfxform_tmp_box
            \tex_special:D { pdf: ~ put ~ @resources ~ << #2 >> }
            \tl_if_empty:nTF {#1} {
                \tex_special:D { pdf: ~ exobj }
            } {
                \tex_special:D { pdf: ~ exobj ~ << #1 >> }
            }
        }
    }
}
...
\cs_new_protected:Npn \hawkdraw_support_pdfxform_use:N #1 {
    ...
    \sys_if_engine_xetex:T {
        \hbox_set:Nn \g__hawkdraw_support_pdfxform_tmp_box {
            \tex_special:D {
                pdf: ~ uxobj ~ @hawkdraw.xobj \int_use:N #1
            }
        }
        \box_set_wd:Nn \g__hawkdraw_support_pdfxform_tmp_box {
            \use:c { c__hawkdraw_support_pdfxform_ \int_use:N #1 _wd_dim }
        }
        \box_set_ht:Nn \g__hawkdraw_support_pdfxform_tmp_box {
            \use:c { c__hawkdraw_support_pdfxform_ \int_use:N #1 _ht_dim }
        }
        \box_set_dp:Nn \g__hawkdraw_support_pdfxform_tmp_box {
