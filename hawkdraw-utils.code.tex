...
\cs_new_protected:Npn \hawkdraw_support_pdflastobj: {
    \sys_if_engine_luatex:T {
    ...
    \sys_if_engine_xetex:T {
        % reference a custom id where necessary
    }
}
...
\cs_new_protected:Npn \hawkdraw_support_pdfxform:nnN #1#2#3 {
    ...
    \sys_if_engine_xetex:T {
        \hook_gput_next_code:nn { shipout / background } {
            \mode_leave_vertical:
            \tex_special:D {
                pdf: bxobj ~ @pdf.xform \int_use:N \g__hawkdraw_support_pdfxform_int \c_space_tl 
