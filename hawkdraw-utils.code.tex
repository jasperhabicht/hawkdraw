...
\box_new:N \l__hawkdraw_support_pdfxform_box
\cs_new_protected:Npn \hawkdraw_support_pdfxform:nnN #1#2#3 {
    ...
    \sys_if_engine_xetex:T {
        ...
        \box_set_wd:Nn #3 { \c_zero_dim }
        \box_set_ht:Nn #3 { \c_zero_dim }
        \box_set_dp:Nn #3 { \c_zero_dim }
...
\cs_new_protected:Npn \hawkdraw_support_pdfxform_use:N #1 {
    ...
    \sys_if_engine_xetex:T {
        \hbox_set:Nn \l__hawkdraw_support_pdfxform_box {
            \tex_special:D {
                pdf: ~ uxobj ~ @hawkdraw.xobj \int_use:N #1 \scan_stop:
            }
        }
        \box_set_wd:Nn \l__hawkdraw_support_pdfxform_box {
            \use:c { c__hawkdraw_support_pdfxform_ \int_use:N #1 _wd_dim }
        }
        \box_set_ht:Nn \l__hawkdraw_support_pdfxform_box {
            \use:c { c__hawkdraw_support_pdfxform_ \int_use:N #1 _ht_dim }
        }
        \box_set_dp:Nn \l__hawkdraw_support_pdfxform_box {
            \use:c { c__hawkdraw_support_pdfxform_ \int_use:N #1 _dp_dim }
        }
        \box_use_drop:N \l__hawkdraw_support_pdfxform_box
    }
}
...
\cs_new:Npn \hawkdraw_support_pdfxform_ref:N #1 {
    ...
    \sys_if_engine_xetex:T {
        @hawkdraw.xobj \int_use:N #1 \scan_stop:
    }
}
