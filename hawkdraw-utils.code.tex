...
\cs_new_protected:Npn \hawkdraw_support_pdfsave: {
    \sys_if_engine_luatex:TF {
...
\cs_new_protected:Npn \hawkdraw_support_pdfrestore: {
    \sys_if_engine_luatex:TF {
...
\cs_new_protected:Npn \hawkdraw_support_pdfsetmatrix:nnnn #1#2#3#4 {
    \sys_if_engine_luatex:TF {
        \tex_pdfextension:D setmatrix { #1 ~ #2 ~ #3 ~ #4 }
    } {
        \tex_pdfsetmatrix:D { #1 ~ #2 ~ #3 ~ #4 }
    } 
}
